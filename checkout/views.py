...
stripe.api_key = 'sk_test_51KsLcQBiXCObZdrCGPlO7K5GVyXfgJpCtaC4j239XtaV7swqVHGBOjbIuIddFhJLhLW1CWcRXs27dD3eeanGtmuA00VZzabx5L'
...
class OrderConfirmAPIView(APIView):
    def post(self, request):
        ...
        send_mail(
            ...
            from_email='farazabir50@gmail.com',
            recipient_list=['farazabir50@gmail.com']
        )

        # Admin mail
        send_mail(
            subject="An Order has been completed",
            message="You earned $" + str(order.ambassador_revenue)+" from " +
            str(order.code),
            from_email=settings.EMAIL_HOST_USER,
            recipient_list=['farazahmedabir09@gmail.com']
        )
